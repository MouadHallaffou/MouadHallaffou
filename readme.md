# <div align="center">👋 Hello, I'm Mouad Hallaffou | Salut, je suis Mouad Hallaffou</div>
...
<div align="center">
  <p style="max-width: 600px; margin: 0 auto; font-size: 16px; line-height: 1.6;">
    Développeur web et mobile passionné du Maroc, spécialisé dans la création d'applications web et mobiles modernes, responsives et conviviales. Avec une expertise en développement front-end et back-end, j'explore constamment de nouvelles technologies pour perfectionner mes compétences et livrer des solutions innovantes multiplateformes.
  </p>
</div>
...
## <div align="center">🎯 <span style="color: #70A5FD;">Projets En Vedette</span></div>
...
<div align="center">
  <table>
    <tr>
      <td align="center" width="50%">
           <h3>🛒 EasyPrint</h3>
           <p>Plateforme de librairie pour gérer et vendre des livres</p>
           <p><strong>Tech :</strong> Laravel, JavaScript, MySQL, Tailwind</p>
        <a href="https://github.com/MouadHallaffou/EasyPrint">
          <img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/>
        </a>
...
- **[Application Calculatrice](https://mouadhallaffou.github.io/Calculator/)** - Calculatrice moderne avec interface épurée (JavaScript, Tailwind)
- **[Plateforme Youdemy](https://github.com/MouadHallaffou/Youdemy_plateform)** - Plateforme e-learning avec gestion de cours (PHP, JavaScript, MySQL)
- **[Blog Dev.to](https://github.com/MouadHallaffou/Dev.to_Blogging_Plateform)** - Plateforme de blog tech inspirée de Dev.to (PHP, Bootstrap, MySQL)
...
<div align="center">
  <ul style="list-style: none; padding: 0;">
    <li>🎯 Participation à l'<strong>Atelier YouCodeScrum Board</strong> - Construction d'un tableau Scrum en JavaScript pur</li>
    <li>♿ Formation en <strong>Accessibilité HTML & CSS</strong> - Amélioration de l'UI/UX pour une meilleure inclusivité</li>
    <li>🏅 Certifié en <strong>JavaScript</strong> par <a href="https://www.codecademy.com/">Codecademy</a></li>
    <li>🚀 Participation active aux hackathons et rencontres de développeurs</li>
  </ul>
</div>
...
<div align="center">
  <p>Je crois fermement au partage des connaissances et à l'aide aux autres dans la communauté des développeurs :</p>
  
  - 💬 Aide aux débutants en programmation sur Discord (**Nom d'utilisateur :** CodingChampions)
  ...
  - 📝 Partage des meilleures pratiques et ressources sur GitHub
</div>
...
<div align="center">
  <p style="color: #70A5FD; font-style: italic; margin-top: 20px;">
    ⭐ N'hésitez pas à mettre une étoile à mes dépôts si vous les trouvez utiles !
  </p>
</div>
